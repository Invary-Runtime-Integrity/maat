...
#define apb_loginfo(fmt, ...) \
    dlog(6, "[APB] " fmt, ##__VA_ARGS__)
#define apb_logerror(fmt, ...) \
    dlog(3, "[APB] " fmt, ##__VA_ARGS__)
#define apb_logwarn(fmt, ...) \
    dlog(4, "[APB] " fmt, ##__VA_ARGS__)
#define apb_logdebug(fmt, ...) \
    dlog(7, "[APB] " fmt, ##__VA_ARGS__)
